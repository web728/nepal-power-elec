...
export function FinalCta() {
  ...
  <TrackedLink
    ...
    className="inline-flex min-h-[52px] items-center justify-center gap-2 rounded-lg bg-yellow px-8 py-4 text-base font-semibold text-ink transition-colors duration-150 hover:bg-yellow-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-white"
  >
    Book a Stand
  </TrackedLink>
